...
// Call with: curl -X POST https://your-vercel-app.vercel.app/api/migrate -H "Authorization: Bearer YOUR_SECRET"
// After migration, DELETE THIS FILE or protect it with the same secret.
...
const MIGRATION_SECRET = process.env.MIGRATION_SECRET || 'temp-secret-change-me';
